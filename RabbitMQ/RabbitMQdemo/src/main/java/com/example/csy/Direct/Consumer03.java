package com.example.csy.Direct;
...
public class Consumer03 {
    ...
    public static void main(String[] args) {
        try {
            ...
            //开始绑定
            //队列三对交换机说，关于美女和股票的消息给我
            channel.queueBind(QUEUE_NAME_03, EXCHANGE_NAME, ROUTING_KEY_BEAUTY);
            channel.queueBind(QUEUE_NAME_03, EXCHANGE_NAME, ROUTING_KEY_STOCK);
            //模拟接收消息
