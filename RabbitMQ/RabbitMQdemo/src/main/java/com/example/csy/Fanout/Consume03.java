package com.example.csy.Fanout;
...
public class Consume03 {
    ...
    private static final String QUEUE_NAME_03 = "local::mq02:queue:q03";
    public static void main(String[] args) {
        try {
            ...
            channel.queueBind(QUEUE_NAME_03, EXCHANGE_NAME, routeKey);
