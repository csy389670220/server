package com.example.csy.rabbitMQ.recordItem;
...
public class RecordItemListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(RecordItemListener.class);
